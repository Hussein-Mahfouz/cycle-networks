...
used by Grisé and El-Geneidy (2018)).
...
(Mauttone et al., 2017), by assigning different weights to the road
segments that are (a) proportional to the investment cost of bringing them to an
acceptable level of stress for cycling (Duthie and Unnikrishnan, 2014), or (b) inversely proportional to
perceived level of stress experienced by cyclists (Wysling and Purves, 2022).
...
It is also different to the weighting profile used by Wysling and Purves (2022) as it adds a larger
