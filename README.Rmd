...
(Bee Network) that will be delivered over 10 years [@manchestercyclingbee2020]. While schemes 
...
Output Areas (MSOA) --- by mode of travel (this is similar to the approach 
used by @grise2018if). 
MSOAs have an average
...
[@mauttone2017bicycle], by assigning different weights to the road
segments that are (a) proportional to the investment cost of bringing them to an
acceptable level of stress for cycling [@duthie2014optimization], or (b) inversely proportional to 
perceived level of stress experienced by cyclists [@wysling2022improve].
...
It is also different to the weighting profile used by @wysling2022improve as it adds a larger
weight on trunk and primary roads then other roads without cycling infrastructure.
