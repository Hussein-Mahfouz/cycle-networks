...
limitation of these problem formulations do not explicitly solve for
...
[@jafino2020transport]. @nahmias2017integrating criticize the
...
area. @pereira2017distributive also emphasize the need for a more
...
on these roads is only slightly higher than remaining road types (See
...
the ideal of fair distribution by using community detection to partition
the road network.
...
different algorithms to determine where investments in cycling
infrastructure should be prioritized. These algorithms, based on
