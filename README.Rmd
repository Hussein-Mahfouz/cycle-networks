...
Separation from motorized vehicles has found to be key [@winters2011motivators].
...
@grisé2018 developed a multi-criteria approach, combined with estimated levels of usage, to highlight routes most in need of investment in Quebec City.
@wysling2022 present a method that used open data from Paris to generate cycling suitability ratings based on 'bicycle suitability multipliers' associated with different types of road across the city, to support more effective interventions.
