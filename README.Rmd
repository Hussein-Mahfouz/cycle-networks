...
Relying only on existing cycling activity to prioritise cycling
infrastructure can reinforce existing cycling patterns and ignores
potential cycling demand that could be satisfied by a connected network.
To avoid this issue, @duthie2014optimization choose to ignore existing
demand completely, and focus on creating a network that connects the
entire study area. @olmos2020data obtain the distance distribution of
...
*Origin-Destination (OD)* data can be obtained from a range of sources,
