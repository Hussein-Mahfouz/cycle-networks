...
#linenumbers: true
numbersections: true
abstract: "Understanding the motivators and deterrents to cycling is essential for creating infrastructure that gets more people to adopt cycling as a mode of transport. The aim of this paper is to develop methods to support the prioritisation of cycling infrastructure and cycling network design, accounting for cyclist preferences and the growing emphasis on 'filtered permeability' and 'Low Traffic Neighborhood' interventions internationally. Distance decay, routing, and network analysis techniques are used to examine where future cycling demand is most likely to arise, how such demand could be accomodated within existing street networks, and how to ensure a fair distribution of investment. The city of Manchester is used as a case study to demonstrate the methods which, as demonstrated in reproducible code and open access data accompanying the paper, can be applied to any city. We find that flexible routing profiles that are adjustable to local needs can avoid high-stress road segments, enabling the identification of networks that balance directness against the need for safe and stress-free routes. Community detection is used to partition the city and evaluate results from 'utilitarian' and 'egalitarian' policy perspectives. Based on discussion of the findings from a policy perspective, we conclude that the 'egalitarian' model prioritisation approach demonstrated in this paper has great potential to support cost-effective strategic cycle network planning internationally. \\par\\textbf{Keywords:} cycling networks, low-traffic neighborhoods, routing, transport equity"
...
The methods can support the ongoing shift in transport planning towards active transport that is being promoted by the UK government and other authorities at city, regional and national levels worldwide. The success of such a shift depends on the appeal of the cycling network for prospective cyclists, a fact that was used as the basis for the methodology outlined here. 
