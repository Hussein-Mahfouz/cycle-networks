...
On the other hand, @mauttone2017bicycle developed an optimization framework aiming at minimizing the total
user cost of cycling on the network without considering car usage. The aggregate flow^[*flow* is
...
components*. @natera2019data for example,
...
function of distance and hilliness [@lovelace2017propensity]. We used the Government Target scenario,
...
```{r potdemhistograms, fig.cap="Distribution of potential cycling demand", out.width="100%", fig.show='hold', fig.align="center", echo=FALSE}
...
2.  **Low-Traffic Neighbourhoods (LTNs)**: The UK Department for Transport is
...
approach adopted by @mauttone2017bicycle, as it makes use of a hierarchy
...
```{r boxplotcircuity, fig.cap="Effect of banning cyclists from trunk and primary roads for all OD pairs (Manchester)", out.width="35%", fig.show='hold', fig.align="center", echo=FALSE}
...
described in @gehrke2020cycling and @furth2016network. A sensitivity
...
```{r cyclinghistmanc, fig.cap="Cycling commuting distance - Manchester (2011 census data)", out.width="30%", fig.show='hold', fig.align = "center", echo=FALSE}
...
```{r communitiesmanchester, fig.cap="Communities based on potential cycling demand between MSOAs (Manchester)", out.width="75%", fig.show='hold', fig.align = "center", echo=FALSE}
...
important given research showing substantial *inequalities*
