...
\begin{figure}
\includegraphics[width=0.3\linewidth]{data/Birmingham/Plots/histogram_distance_all_vs_cycling} \includegraphics[width=0.3\linewidth]{data/Birmingham/Plots/histogram_distance_all_vs_cycling_potential} \includegraphics[width=0.3\linewidth]{data/Birmingham/Plots/histogram_distance_cycling_potential_vs_current} \caption{Distribution of Potential Cycling Demand}\label{fig:potdemhistogramsBirmingham}
\end{figure}

\begin{figure}[H]

{\centering \includegraphics[width=0.8\linewidth]{data/Birmingham/Plots/desire_facet_cycling} 
...
{\centering \includegraphics[width=0.45\linewidth]{data/Birmingham/Plots/Growth_Results/growth_utilitarian_satisfied_km_both_flow_column} \includegraphics[width=0.45\linewidth]{data/Birmingham/Plots/Growth_Results/growth_egalitarian_satisfied_km_both_flow_column} 
...
{\centering \includegraphics[width=0.45\linewidth]{data/Birmingham/Plots/Growth_Results/growth_util_egal_components_number_comparisonBirmingham} \includegraphics[width=0.45\linewidth]{data/Birmingham/Plots/Growth_Results/growth_util_egal_components_gcc_comparisonBirmingham} 
...
{\centering \includegraphics[width=0.45\linewidth]{data/Birmingham/Plots/Growth_Results/growth_egalitarian_priority_all_FLOW} 
...
\begin{figure}
\includegraphics[width=0.3\linewidth]{data/Leeds/Plots/histogram_distance_all_vs_cycling} \includegraphics[width=0.3\linewidth]{data/Leeds/Plots/histogram_distance_all_vs_cycling_potential} \includegraphics[width=0.3\linewidth]{data/Leeds/Plots/histogram_distance_cycling_potential_vs_current} \caption{Distribution of Potential Cycling Demand}\label{fig:potdemhistogramsLeeds}
\end{figure}

\begin{figure}[H]

{\centering \includegraphics[width=0.8\linewidth]{data/Leeds/Plots/desire_facet_cycling} 
...
{\centering \includegraphics[width=0.75\linewidth]{data/Leeds/Plots/flows_facet_unweighted_Leeds} 
...
{\centering \includegraphics[width=0.75\linewidth]{data/Leeds/Plots/flows_facet_weighted_Leeds} 
...
{\centering \includegraphics[width=0.9\linewidth]{data/Leeds/Plots/communities_alternative_Leeds} 
...
{\centering \includegraphics[width=0.45\linewidth]{data/Leeds/Plots/Growth_Results/growth_utilitarian_satisfied_km_both_flow_column} \includegraphics[width=0.45\linewidth]{data/Leeds/Plots/Growth_Results/growth_egalitarian_satisfied_km_both_flow_column} 
...
{\centering \includegraphics[width=0.45\linewidth]{data/Leeds/Plots/Growth_Results/growth_util_egal_components_number_comparisonLeeds} \includegraphics[width=0.45\linewidth]{data/Leeds/Plots/Growth_Results/growth_util_egal_components_gcc_comparisonLeeds} 
...
{\centering \includegraphics[width=0.45\linewidth]{data/Leeds/Plots/Growth_Results/growth_egalitarian_priority_all_FLOW} \includegraphics[width=0.45\linewidth]{data/Leeds/Plots/Growth_Results/growth_egalitarian_investment_highways_flow} 

}

\caption{Road Segment Priority (left), disaggregated by road type (right) - Egalitarian Growth}\label{fig:growth3MapandBarLeeds}
\end{figure}

\clearpage

\hypertarget{nottingham}{%
\subsection{Nottingham}\label{nottingham}}

\subsubsection{Potential Demand}

\begin{figure}
\includegraphics[width=0.3\linewidth]{data/Nottingham/Plots/histogram_distance_all_vs_cycling} \includegraphics[width=0.3\linewidth]{data/Nottingham/Plots/histogram_distance_all_vs_cycling_potential} \includegraphics[width=0.3\linewidth]{data/Nottingham/Plots/histogram_distance_cycling_potential_vs_current} \caption{Distribution of Potential Cycling Demand}\label{fig:potdemhistogramsNottingham}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.45\linewidth]{data/Nottingham/Plots/Growth_Results/growth_utilitarian_satisfied_km_both_flow_column} \includegraphics[width=0.45\linewidth]{data/Nottingham/Plots/Growth_Results/growth_egalitarian_satisfied_km_both_flow_column} \caption{Comparing Overall (Dashed) and Community Level Person-Km Satisfied (Nottingham)}\label{fig:growthtotalNottingham}
\end{figure}

\begin{figure}[H]

{\centering \includegraphics[width=0.45\linewidth]{data/Nottingham/Plots/Growth_Results/growth_util_egal_components_number_comparisonNottingham} \includegraphics[width=0.45\linewidth]{data/Nottingham/Plots/Growth_Results/growth_util_egal_components_gcc_comparisonNottingham} 
...
{\centering \includegraphics[width=0.45\linewidth]{data/Nottingham/Plots/Growth_Results/growth_egalitarian_priority_all_FLOW} \includegraphics[width=0.45\linewidth]{data/Nottingham/Plots/Growth_Results/growth_egalitarian_investment_highways_flow} 
