...
%DIF DEL paper_round_2.tex   Sat Sep 23 14:02:57 2023
%DIF ADD README.tex          Fri Sep 22 18:07:04 2023
...
\hypertarget{case-study-area}{%
\subsection{Case study area}\label{case-study-area}}

\DIFadd{Manchester is a city in the North West of England.
...
\tightlist
\item
  \DIFadd{Manchester City Council, which is a local government district that includes the city centre and surrounding areas.
}\item
  \DIFadd{The Greater Manchester region, which is a metropolitan county that includes the city of Manchester and 9 other local government districts.
}\item
  \DIFadd{The city of Manchester, which is used by visitors to refer to the city centre and surrounding areas. This definition if formalised in the Major Towns and Cities (TCITY) dataset provided by the Office for National Statistics.
}\end{itemize}

\DIFadd{We use the TCITY definition of Manchester, which was ``developed specifically for the production and analysis of statistics'' and which is shown in Figure \ref{fig:manchestermap}.
}

\DIFmodbegin
\begin{DIFverbatim}[alsolanguage=DIFcode]
%DIF > ##   [1] "geo_code"                "geo_name"               
%DIF > ##   [3] "lad11cd"                 "lad_name"               
%DIF > ##   [5] "all"                     "bicycle"                
%DIF > ##   [7] "foot"                    "car_driver"             
%DIF > ##   [9] "car_passenger"           "motorbike"              
%DIF > ##  [11] "train_tube"              "bus"                    
%DIF > ##  [13] "taxi_other"              "govtarget_slc"          
%DIF > ##  [15] "govtarget_sic"           "govtarget_slw"          
%DIF > ##  [17] "govtarget_siw"           "govtarget_sld"          
%DIF > ##  [19] "govtarget_sid"           "govtarget_slp"          
%DIF > ##  [21] "govtarget_sip"           "govtarget_slm"          
%DIF > ##  [23] "govtarget_sim"           "govtarget_slpt"         
%DIF > ##  [25] "govtarget_sipt"          "govnearmkt_slc"         
%DIF > ##  [27] "govnearmkt_sic"          "govnearmkt_slw"         
%DIF > ##  [29] "govnearmkt_siw"          "govnearmkt_sld"         
%DIF > ##  [31] "govnearmkt_sid"          "govnearmkt_slp"         
%DIF > ##  [33] "govnearmkt_sip"          "govnearmkt_slm"         
%DIF > ##  [35] "govnearmkt_sim"          "govnearmkt_slpt"        
%DIF > ##  [37] "govnearmkt_sipt"         "gendereq_slc"           
%DIF > ##  [39] "gendereq_sic"            "gendereq_slw"           
%DIF > ##  [41] "gendereq_siw"            "gendereq_sld"           
%DIF > ##  [43] "gendereq_sid"            "gendereq_slp"           
%DIF > ##  [45] "gendereq_sip"            "gendereq_slm"           
%DIF > ##  [47] "gendereq_sim"            "gendereq_slpt"          
%DIF > ##  [49] "gendereq_sipt"           "dutch_slc"              
%DIF > ##  [51] "dutch_sic"               "dutch_slw"              
%DIF > ##  [53] "dutch_siw"               "dutch_sld"              
%DIF > ##  [55] "dutch_sid"               "dutch_slp"              
%DIF > ##  [57] "dutch_sip"               "dutch_slm"              
%DIF > ##  [59] "dutch_sim"               "dutch_slpt"             
%DIF > ##  [61] "dutch_sipt"              "ebike_slc"              
%DIF > ##  [63] "ebike_sic"               "ebike_slw"              
%DIF > ##  [65] "ebike_siw"               "ebike_sld"              
%DIF > ##  [67] "ebike_sid"               "ebike_slp"              
%DIF > ##  [69] "ebike_sip"               "ebike_slm"              
%DIF > ##  [71] "ebike_sim"               "ebike_slpt"             
%DIF > ##  [73] "ebike_sipt"              "base_slcyclehours"      
%DIF > ##  [75] "govtarget_sicyclehours"  "govnearmkt_sicyclehours"
%DIF > ##  [77] "gendereq_sicyclehours"   "dutch_sicyclehours"     
%DIF > ##  [79] "ebike_sicyclehours"      "base_sldeath"           
%DIF > ##  [81] "base_slyll"              "base_slvalueyll"        
%DIF > ##  [83] "base_slsickdays"         "base_slvaluesick"       
%DIF > ##  [85] "base_slvaluecomb"        "govtarget_sideath"      
%DIF > ##  [87] "govtarget_siyll"         "govtarget_sivalueyll"   
%DIF > ##  [89] "govtarget_sisickdays"    "govtarget_sivaluesick"  
%DIF > ##  [91] "govtarget_sivaluecomb"   "govnearmkt_sideath"     
%DIF > ##  [93] "govnearmkt_siyll"        "govnearmkt_sivalueyll"  
%DIF > ##  [95] "govnearmkt_sisickdays"   "govnearmkt_sivaluesick" 
%DIF > ##  [97] "govnearmkt_sivaluecomb"  "gendereq_sideath"       
%DIF > ##  [99] "gendereq_siyll"          "gendereq_sivalueyll"    
%DIF > ## [101] "gendereq_sisickdays"     "gendereq_sivaluesick"   
%DIF > ## [103] "gendereq_sivaluecomb"    "dutch_sideath"          
%DIF > ## [105] "dutch_siyll"             "dutch_sivalueyll"       
%DIF > ## [107] "dutch_sisickdays"        "dutch_sivaluesick"      
%DIF > ## [109] "dutch_sivaluecomb"       "ebike_sideath"          
%DIF > ## [111] "ebike_siyll"             "ebike_sivalueyll"       
%DIF > ## [113] "ebike_sisickdays"        "ebike_sivaluesick"      
%DIF > ## [115] "ebike_sivaluecomb"       "base_slcarkm"           
%DIF > ## [117] "base_slco2"              "govtarget_sicarkm"      
%DIF > ## [119] "govtarget_sico2"         "govnearmkt_sicarkm"     
%DIF > ## [121] "govnearmkt_sico2"        "gendereq_sicarkm"       
%DIF > ## [123] "gendereq_sico2"          "dutch_sicarkm"          
%DIF > ## [125] "dutch_sico2"             "ebike_sicarkm"          
%DIF > ## [127] "ebike_sico2"             "perc_rf_dist_u10km"     
%DIF > ## [129] "avslope_perc_u10km"      "geometry"               
%DIF > ## [131] "pcycle"
\end{DIFverbatim}
\DIFmodend
...
\DIFmodbegin
\begin{DIFverbatim}[alsolanguage=DIFcode]
%DIF > ## Warning: st_centroid assumes attributes are constant over geometries
\end{DIFverbatim}
\DIFmodend
