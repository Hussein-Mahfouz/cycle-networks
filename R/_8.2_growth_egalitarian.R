...
ggplot(data=grow_egal_c, mapping=aes(x=dist_c, y = perc_person_km_comm_c)) +
...
tm_shape(grow_egal_c) +
  ...
  tm_layout(title = "Algorithm 2 (Egalitarian)",        
            title.size = 1.2,
            title.color = "azure4",
...
tm_shape(initial_infra) +
  ...
  tm_facets(by="Community",
            nrow = 1,
            free.coords=FALSE)  +  # so that the maps aren't different sizes +
  tm_layout(main.title = "Algorithm 2 (Egalitarian)",        
            main.title.size = 1.2,
...
tm_shape(grow_egal_c_100) +
  ...
  tm_facets(by="Community",
            nrow = 1,
            free.coords=FALSE)  +  # so that the maps aren't different sizes
  tm_layout(main.title = "Algorithm 2 (Egalitarian) - Distribution of Initial 100km of Investment",        
            main.title.size = 1.2,
            main.title.color = "azure4",
            main.title.position = c("left", "top"),
            fontfamily = 'Georgia',
