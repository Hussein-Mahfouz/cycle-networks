...
This repository contains the code used for the paper. Below is an explanation of the scripts used, and how the analysis can be reproduced. 
...
There is one file that cannot be synced to github due to its size. This file is neseccary for the scripts to run: 
