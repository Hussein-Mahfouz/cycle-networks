...
author:
  ...
  - name: Robin Lovelace
    institute: its
institute:
  - casa: The Centre for Advanced Spatial Analysis, University College London, London, UK
  - its: Institute of Transport Studies, University of Leeds, Leeds, UK
...
# (APPENDIX) Appendix {-} 
\clearpage
# Appendix: Reproducing the results for other cities  
...
- The source code of the paper repository, which can be download from this [Github repository](https://github.com/Hussein-Mahfouz/cycle-networks)]
...
```{r growthtotalBirmingham, fig.cap="Comparing Overall (Dashed) and Community Level Person-Km Satisfied (Birmingham)", out.width="45%", fig.show='hold', fig.pos="H", fig.align = "center", echo=FALSE}
knitr::include_graphics(c(
